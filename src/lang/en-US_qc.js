export default {
    ...
    teamManagement: {
        ...
        actions: 'Actions',
        membersTab: 'Members',
        formsTab: 'Default Associated Forms',
        table: {
            id: 'ID',
            name: 'Name',
            type: 'Type',
        ...
        addDialog: {
            ...
            endTime: 'End Time',
            members: 'Members',
            forms: 'Default Associated Forms',
            description: 'Description',
            status: 'Status',
            cancelButton: 'Cancel',
            confirmButton: 'Confirm',
        ...
        messages: {
            ...
            statusUpdatedSuccess: 'Status updated successfully',
            statusUpdatedFailed:  'Failed to update status',
            defaultFormTooltip: 'When there is no form access schedule in the calendar for the current time, the default forms will be shown to the team',
        },
    },
    shiftManagement: {
    ...
    formAccessCalendar: {
        ...
        refreshDescription: 'Refresh Calendar',
        ...
        endDate: 'End Date',
        startDateRecur: 'Recurrence Start Date',
        endDateRecur: 'Recurrence End Date',
        ...
        saturday: 'Saturday',
        sunday: 'Sunday',
        accessibleForm: 'Accessible Form',
        groupId: 'Group ID',
        year: 'Year',
        month: 'Month',
        week: 'Week',
